...
const EditarEnderecoForm = ({ tomadorData, token, handleReload }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    useEffect(() => {
        ...
        cep.value = String(tomadorData?.cep).replace("-", "")
        setCepData({
            bairro: tomadorData?.bairro,
            cep: tomadorData?.cep,
            uf: tomadorData?.estado,
            localidade: tomadorData?.cidade,
            logradouro: tomadorData?.rua,
        })
    ...
    const onSubmit = async (values) => {
        try {
            setLoading(true)
            const res = await axios.patch(`${baseUrl}/api/tomadores/${tomadorData.id}/dados-endereco`, values, {
                headers: {
            ...
            >
                ...
                <div className={'flex gap-2 w-full max-w-xs items-end'}>
                    <div className="form-control w-full max-w-xs">
                        ...
                        <input
                            ...
                            placeholder="CEP"
                            maxLength={8}
                            defaultValue={String(tomadorData?.cep).replace("-", "")}
                        />
                ...
                >
                    ...
                    <div className="form-control  flex-auto w-1/5 max-w-xs">
                        ...
                        <input
                            defaultValue={tomadorData?.numero ? tomadorData?.numero : ""}
                            name="numero"
                            id="numero"
                            {...register('numero')}
                            type="text"
                ...
                >
                    ...
                    <input
                        defaultValue={tomadorData?.complemento ? tomadorData?.complemento : ""}
                        name="complemento"
                        id="complemento"
